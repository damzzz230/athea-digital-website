...
const PAGE_DESCRIPTIONS = {
  '/':          'Athea Digital builds premium websites for Johannesburg businesses — salons, trades, restaurants, fitness, tattoo studios and more. We design your site first — see it, approve it, and pay 50% to kick off. Full build delivered in 2–3 weeks.',
  '/about':     'We\'re a two-person web design studio based in Johannesburg. We build fast, mobile-first websites for local businesses — we design it first, you approve it, then pay 50% to start. Full site delivered in 2–3 weeks.',
